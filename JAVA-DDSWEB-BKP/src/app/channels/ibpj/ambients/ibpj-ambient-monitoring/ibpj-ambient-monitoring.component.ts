...
import { IbpjAmbientMonitoringConfirmModalComponent } from './ibpj-ambient-monitoring-confirm-modal/ibpj-ambient-monitoring-confirm-modal.component';
// services
...
@Component({
  selector: 'ibpj-ambient-monitoring',
  templateUrl: './ibpj-ambient-monitoring.component.html',
  styleUrls: ['./ibpj-ambient-monitoring.component.scss']
})
export class IbpjAmbientMonitoringComponent implements OnInit {
  ...
  modules = [
    {
      ...
      ambients : [
        {urlAmbiente: 'pj.santandernetibe.com.br', balance: 0.942059191, statusMod: [{actualStatus: 'Online', activeConections: 6780000}], clicked: false, public: [{int: true, ext: false}]},
        {urlAmbiente: 'ocu.santandernetibe.com.br', balance: 0, statusMod: [{actualStatus: 'Offline', activeConections: 0}], clicked: false, public: [{int: false, ext: false}]},
        {urlAmbiente: 'ibj.deploy.santandernetibe.com.br', balance: 0, statusMod: [{actualStatus: 'Offline', activeConections: 0}], clicked: false, public: [{int: false, ext: false}]},
      ],
    },
    {
    nomeModulo: 'Módulo 2', version: [{release: 'v1.0.1', similarName: 'Real'}],
    ambients : [
        {urlAmbiente: 'pj.santandernetibe.com.br', balance: 0.00972627483673753, statusMod: [{actualStatus: 'Online', activeConections: 70000}], clicked: false, public: [{int: false, ext: false}]},
        {urlAmbiente: 'ocu.santandernetibe.com.br', balance: 0.333333333333333, statusMod: [{actualStatus: 'Online', activeConections: 6000}], clicked: false, public: [{int: false, ext: false}]},
        {urlAmbiente: 'ibj.deploy.santandernetibe.com.br', balance: 0, statusMod: [{actualStatus: 'Offline', activeConections: 0}], clicked: false, public: [{int: false, ext: false}]},
      ],
    },
    {
    ...
    ambients : [
        {urlAmbiente: 'pj.santandernetibe.com.br', balance: 0.0482145338335418, statusMod: [{actualStatus: 'Online', activeConections: 347000}], clicked: false, public: [{int: false, ext: false}]},
        {urlAmbiente: 'ocu.santandernetibe.com.br', balance: 0.666666666666667, statusMod: [{actualStatus: 'Online', activeConections: 12000}], clicked: false, public: [{int: false, ext: false}]},
        {urlAmbiente: 'ibj.deploy.santandernetibe.com.br', balance: 1, statusMod: [{actualStatus: 'Online', activeConections: 1000}], clicked: false, public: [{int: false, ext: false}]},
      ],
    },
    {
    nomeModulo: 'Módulo 4', version: [{release: 'v1.0.1', similarName: 'Preservado'}],
    ambients : [
        {urlAmbiente: 'pj.santandernetibe.com.br', balance: 0, statusMod: [{actualStatus: 'Offline', activeConections: 0}], clicked: false, public: [{int: false, ext: false}]},
        {urlAmbiente: 'ocu.santandernetibe.com.br', balance: 0, statusMod: [{actualStatus: 'Offline', activeConections: 0}], clicked: false, public: [{int: false, ext: false}]},
        {urlAmbiente: 'ibj.deploy.santandernetibe.com.br', balance: 0, statusMod: [{actualStatus: 'Offline', activeConections: 0}], clicked: false, public: [{int: false, ext: false}]},
      ],
    },
  ...
  ngOnInit() {
    ...
    this.ctrlAlterarModulo = this.verificarPerfil('Alterar', 'DDS-CTRL-IBE-CONFIFURACOES');
  }
  ...
  changeState(indexMod, indexAmb) {
    ...
    const dialogRef = this.dialog.open(IbpjAmbientMonitoringConfirmModalComponent, {
