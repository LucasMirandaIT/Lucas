...
@Component({
  selector: 'create-selection2',
  templateUrl: './create-selection2.component.html',
  styleUrls: ['./create-selection2.component.scss']
})
export class CreateSelection2Component implements OnInit, AfterViewInit {
